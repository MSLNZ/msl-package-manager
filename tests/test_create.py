...
def test_create_msl_package():
    ...
    with open(os.path.join(root_dir, 'setup.py'), 'r') as fp:
        ...
        assert "init_original = 'msl/package/__init__.py'" == lines[159]
        assert "    name='msl-package'," == lines[164]
        assert "    url='https://github.com/MSLNZ/msl-package'," == lines[168]
        assert "    description='Write a short description about msl-package here'," == lines[169]
        assert "    packages=find_packages(include=('msl*',))," == lines[179]
...
def test_create_pr_single_photons():
    ...
    for namespace in ['pr', 'pr-', 'PR----']:
        ...
        with open(os.path.join(root_dir, 'setup.py'), 'r') as fp:
            ...
            assert "init_original = 'pr/Single_Photons/__init__.py'" == lines[159]
            assert "    name='pr-Single-Photons'," == lines[164]
            assert "    url='https://github.com/MSLNZ/pr-Single-Photons'," == lines[168]
            assert "    description='Write a short description about pr-Single-Photons here'," == lines[169]
            assert "    packages=find_packages(include=('pr*',))," == lines[179]
...
def test_create_no_namespace():
    ...
    with open(os.path.join(root_dir, 'setup.py'), 'r') as fp:
        ...
        assert "init_original = 'time_tagger/__init__.py'" == lines[159]
        assert "    name='time-tagger'," == lines[164]
        assert "    url='https://github.com/MSLNZ/time-tagger'," == lines[168]
        assert "    description='Write a short description about time-tagger here'," == lines[169]
        assert "    packages=find_packages(include=('time_tagger',))," == lines[179]
